    ...
    <section>
      ...
      >
        ...
        >
          ...
          >Vul onderstaand formulier in en een lokale organisatie of kerk zal je zo snel mogelijk benaderen om je te helpen.</p>
          <need-help-form />
          <divider class="my-5" />
    ...
    <section>
      ...
      >
        <v-flex xs12 sm8 md5 lg4 xl3>
          ...
          <p
            class="subtitle-1"
          >Ondanks het coronavirus (COVID-19), staan we voor je klaar. Overal in Nederland zetten talloze lokale organisaties en kerken zich in voor mensen die hulp kunnen gebruiken. Praktische hulp nodig? Een luisterend oor? Je bent #Nietalleen.</p>
        </v-flex>
      </v-layout>
    </section>
    <section>
      <v-layout justify-center align-center class="text-center px-8 py-12">
        <v-flex xs12 sm8 md5 lg4 xl3 class="my-5">
          ...
          <p class="subtitle-1">Wil jij je ook aansluiten met een hulp-initiatief?</p>
          <v-btn href="hulp-bieden" color="primary" x-large nuxt class="mt-6">Aanmelden</v-btn>
          <p
            class="body-2 font-weight-bold py-8 px-4"
          >Ben je een particulier en wil je ook graag helpen? We gaan binnenkort op de website laten zien bij welke organisatie bij jou in de buurt je kan aansluiten.</p>
        </v-flex>
      </v-layout>
    </section>
    <section>
      <v-layout justify-center align-center class="text-center accent px-8 py-12">
        <v-flex xs12 sm8 md5 lg4 xl3 class="my-5">
          ...
          <v-btn href="/over" color="primary" class="mt-6" x-large nuxt>Meer lezen over ons</v-btn>
        </v-flex>
      </v-layout>
    </section>
  </div>
